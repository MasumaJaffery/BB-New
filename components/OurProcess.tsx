    ...
    <section className="w-full bg-white px-12 py-14">
      <div className="mx-auto max-w-[1180px]">
        <div className="mb-10 text-center">
          ...
          <h2 className="text-[25px] font-semibold leading-tight text-[#14243d]">
        ...
        <div className="grid grid-cols-5 gap-0">
          {steps.map((step, index) => {
            ...
            return (
              <div
                key={step.number}
                className="relative flex min-h-[150px] flex-col items-center px-7 py-4 text-center"
              >
                {index < steps.length - 1 && (
                  <span className="absolute right-[-1px] top-[18px] w-7 border-t-2 border-dotted border-[#dcc7a9]" />
                )}

                <Icon
                  strokeWidth={1.35}
                  className="mb-2 h-[25px] w-[25px] text-[#17263d]"
                />
